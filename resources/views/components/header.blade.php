                    ...
                    @isset($user)
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="hidden sm:flex items-center space-x-3 px-4 py-2 rounded-lg bg-slate-800/50 backdrop-blur-sm border border-slate-700/50">
                                <div class="w-6 h-6 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white text-sm font-semibold shadow-lg">
