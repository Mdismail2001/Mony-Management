<aside id="sidebar" class="fixed left-0 top-16 bottom-0 w-64 bg-white border-r border-slate-200 z-40 hidden lg:flex flex-col overflow-y-auto">
    ...
    <nav class="flex-1 p-4 space-y-1">
        <a href="#" class="group flex items-center space-x-3 px-4 py-3 rounded-xl bg-gradient-to-r from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 text-emerald-500 shadow-sm transition-all duration-200">
